// Glue code shared between YJIT and ZJIT for FFI.
// For FFI safety and bindgen compatibility reasons some kinds of C functions
// require wrapping before they can be called from Rust. Those show up here.
